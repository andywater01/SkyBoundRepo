...
void ECS::SetIsMainHeart(unsigned entity, bool mainHeart)
{
	//Gets reference to the component
	auto& id = GetComponent<EntityIdentifier>(entity);
	//Sets main player entity
	EntityIdentifier::MainHeart(entity);
	//Sets whether this entity is the main player
	id.SetIsMainHeart(mainHeart);
}

void ECS::SetIsMainEnemy(unsigned entity, bool mainEnemy)
{
	//Gets reference to the component
	auto& id = GetComponent<EntityIdentifier>(entity);
	//Sets main player entity
